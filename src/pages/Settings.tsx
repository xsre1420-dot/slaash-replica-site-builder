...
import { ArrowRight, Upload, X, ChevronLeft, ChevronRight, Star, Truck } from "lucide-react";
                      ...
                      <div className="p-6 bg-white rounded-2xl border border-gray-100">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Input
                            ...
                            onChange={(e) => setSettings(prev => ({ ...prev, deliveryPrice: parseInt(e.target.value) || 0 }))}
                            className="text-right rounded-2xl border-gray-200 text-black"
                            placeholder="2000"
                            min="0"
                          />
