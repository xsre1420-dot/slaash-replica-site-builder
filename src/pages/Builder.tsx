        ...
        <div className="bg-white rounded-xl p-6 shadow-sm mb-8">
          ...
          <div className="flex items-center gap-2 mb-8">
            <Input 
              ...
              readOnly 
              className="text-left bg-accent font-english"
            />
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/preview">
              <Button variant="outline" className="w-full flex items-center justify-center gap-2 py-6 text-primary border-primary hover:bg-accent">
                <Eye className="w-5 h-5 ml-2" />
                معاينة
              </Button>
            </Link>
            <Link to="/add-product">
              <Button className="w-full bg-primary hover:bg-secondary flex items-center justify-center gap-2 py-6 text-white">
        ...
        <Card className="bg-white shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-primary">المنتجات</CardTitle>
