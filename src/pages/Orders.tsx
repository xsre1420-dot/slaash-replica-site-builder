...
import { Search, Eye, CheckCircle, XCircle, Clock, ArrowLeft, AlertCircle, Package, TrendingUp, ShoppingBag } from "lucide-react";
                      ...
                      <div className="text-right">
                        <div className="flex flex-wrap gap-1 justify-end">
                          ...
                          {order.items.length > 3 && (
                            <span className="inline-block bg-muted text-muted-foreground px-2.5 py-0.5 rounded-full text-xs">
