...
export const SERVER_JOB_CATALOG: ServerJobEntry[] = [
  {
    ...
    deadLetter: false,
    recurring: true,
    notes: 'Every minute via pg_cron; also inline flush(50) on track RPCs',
  },
  {
    id: 'analytics.prune',
  ...
  },
  {
    ...
    deadLetter: false,
    recurring: true,
    notes: 'Enqueues webhooks, meta events; idempotent per effect type',
  },
  {
  ...
  },
  {
    ...
    deadLetter: false,
    recurring: false,
    notes: 'Client sync loop or process-import-jobs edge; job status in import_jobs',
  },
  {
