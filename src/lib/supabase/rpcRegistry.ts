...
export const OPTIONAL_RPCS: RpcDefinition[] = [
  ...
  {
    name: 'platform_queue_health_audit',
    domain: 'background',
    status: 'service_role',
  ...
  },
  {
    ...
    status: 'service_role',
    migration: '20260906000006',
    notes: 'Replay poison analytics events from DLQ',
  },
  {
    name: 'retry_side_effects_dead_letter',
    domain: 'background',
    status: 'optional',
    migration: '20260906000006',
    notes: 'Merchant-scoped DLQ replay for checkout side effects',
  },
  {
    name: 'recover_stale_import_jobs',
    domain: 'background',
    status: 'service_role',
    migration: '20260906000006',
