...
const RatingSection = ({ productId, storeSlug, reviews = [] }: RatingSectionProps) => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">
              ({allReviews.length === 0 ? "لا توجد مراجعات" :
                ...
                allReviews.length >= 3 && allReviews.length <= 10 ? `${allReviews.length} مراجعات` :
      ...
      {showReviewForm && (
        <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-muted-foreground text-right mb-2">
                الاسم *
              </label>
              <Input
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="text-center py-8 text-muted-foreground">جاري تحميل التقييمات...</div>
        ) : allReviews.length === 0 ? (
