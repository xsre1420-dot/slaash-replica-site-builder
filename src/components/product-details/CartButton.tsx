  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-6 pt-2 bg-gradient-to-t from-background via-background to-transparent animate-fade-in">
      <Link to="/checkout" className="block max-w-md mx-auto">
        <div className="bg-foreground rounded-2xl shadow-2xl overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-xs text-background/60">المبلغ الكلي</div>
                <div className="text-base font-bold text-background">
                  {totalAmount.toLocaleString()} د.ع
                </div>
              </div>
            </div>
            
            <div className="flex items-center gap-2 text-background font-bold text-sm">
              <span>عرض السلة</span>
