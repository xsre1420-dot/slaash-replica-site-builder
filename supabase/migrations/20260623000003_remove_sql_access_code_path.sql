-- Remove SQL Editor code path; admin panel uses admin_generate_access_code only

DROP FUNCTION IF EXISTS public.sql_generate_access_code(UUID, TEXT, INTEGER, TEXT, TEXT);
