-- v28: Serialize checkout attempts per idempotency key (race-safe duplicate prevention)
...
BEGIN
  ...
  IF p_idempotency_key IS NOT NULL AND trim(p_idempotency_key) <> '' THEN
    -- Serialize concurrent retries / double-submit for the same checkout attempt
...
VALUES (28, 'order_creation_reliability: advisory lock per idempotency key')
