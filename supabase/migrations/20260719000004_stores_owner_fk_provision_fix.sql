-- Drop legacy stores.owner_id FK (restaurant_owners) and fix access-code provisioning.
...
BEGIN
  ...
  INSERT INTO public.stores (
    id, user_id, name, slug, store_name, store_slug, theme_id
  )
  VALUES (
    v_store_id, p_user_id, v_store_name, v_slug, v_store_name, v_slug, 'default'
  );
