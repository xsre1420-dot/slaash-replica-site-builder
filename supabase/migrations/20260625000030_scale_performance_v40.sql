-- v40: Scale performance — dashboard catalog_kpis + restore indexed workflow counts
...
VALUES (40, 'scale_perf: dashboard catalog_kpis + indexed workflow_counts restore')
